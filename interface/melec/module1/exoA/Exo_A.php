...
<header>
        <img src="/wordpress/wp-content/plugins/site/images/logo.webp" alt="logo">
</header>
    <p> <a href="../../module_1.php" class="retour">◀ Retour</a></p>
  <main>

    <h1>Exercices A MELEC</h1>

  </main>

    <div style="display: flex;">
    <button class="btn btn-A bouton-position-A"><span>Scrabble</span>
    <img src="/wordpress/wp-content/plugins/site/images/scrabble2.png" alt="image1" class="img1" width="100"></button>

    <button class="btn btn-B bouton-position-B"><span>Mots croisés</span> 
    <img src="/wordpress/wp-content/plugins/site/images/mot_croisé2.png" alt="image2" class="img2" width="100"></button>

    <button class="btn btn-C bouton-position-C"><span>Quiz</span> 
    <img src="/wordpress/wp-content/plugins/site/images/quiz.png" alt="image3" class="img3" width="100"></button>
    </div>
